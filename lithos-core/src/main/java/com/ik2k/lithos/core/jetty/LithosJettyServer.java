package com.ik2k.lithos.core.jetty;
...
public class LithosJettyServer extends JettyServer{
        ...
        thread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    LithosExecutorRegistryThread.getInstance().start(port, ip, appName);
    ...
    public void destroy() {
        ...
        LithosExecutorRegistryThread.getInstance().toStop();
